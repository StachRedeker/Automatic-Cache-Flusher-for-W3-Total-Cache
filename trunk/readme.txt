...
Tags: automatic cache flusher, cache, cache flush on update, W3 Total cache, clear cache
...
If you are familiar with child themes, then you can add [some code](https://github.com/StachRedeker/Automatic-Cache-Flusher-for-W3-Total-Cache/) to your child theme to achieve the same functionality.
